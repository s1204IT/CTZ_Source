...
static struct imgsensor_info_struct imgsensor_info = {
	.sensor_id = GC5035MIPI_FRONT_SENSOR_ID,
...
{
	return ((read_cmos_sensor(0xf0) << 8) | read_cmos_sensor(0xf1)) + 0x0f0000;
}
...
static kal_uint32 control(
	enum MSDK_SCENARIO_ID_ENUM scenario_id, MSDK_SENSOR_EXPOSURE_WINDOW_STRUCT *image_window,
	MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
	LOG_INF("E\n");
	LOG_INF("scenario_id = %d\n", scenario_id);
...
UINT32 GC5035MIPI_FRONT_RAW_SensorInit(struct SENSOR_FUNCTION_STRUCT **pfFunc)
{
